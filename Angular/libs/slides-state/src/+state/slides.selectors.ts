...
export const selectCurrentPresentationId = createSelector(selectSlidesState, (state: SlidesState) => state.currentPresentationId);
...
export const selectCurrentSlide = createSelector(selectSlideEntities, selectCurrentSlideId, (entities, id) => entities[id]);
